...
labels = [
    ...
    Label(  'outer wall'           , 53 ,        1 , 'void'            , 0       , False        , False        , (111, 74,  0) ),
    Label(  'roof'                 , 64 ,        2 , 'void'            , 0       , False        , False        , ( 81,  0, 81) ),
    Label(  ''                     , 69 ,      255 , 'flat'            , 1       , False        , True         , (128, 64,128) ),
    Label(  'tree'                 , 85 ,        3 , 'flat'            , 1       , False        , False        , (244, 35,232) ),
    Label(  'fence'                , 95 ,        4 , 'flat'            , 1       , False        , False        , (250,170,160) ),
    ...
    Label(  'water'                ,104 ,        5 , 'construction'    , 2       , False        , False        , (190,153,153) ),
    ...
    Label(  'swimming pool'        ,122 ,        6 , 'object'          , 3       , False        , False        , (153,153,153) ),
    ...
    Label(  'grass'                ,205 ,       12 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    ...
    Label(  'car'                  ,220 ,       13 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    Label(  'pole'                 ,221 ,       14 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    Label(  'roof'                 ,222 ,        2 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    Label(  'outer wall'           ,223 ,        1 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    Label(  'hedge'                ,224 ,       15 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    ...
    Label(  'driveway'             ,251 ,       16 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
